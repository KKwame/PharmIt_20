...
// this is the first pane or view after launching the application.
// this has the diagnosis pane and location pane
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: Text(
                "PharmIt",
                style: TextStyle(fontStyle: FontStyle.italic, fontSize: 45.0),
              ),
              centerTitle: true,
            ),
          ),
